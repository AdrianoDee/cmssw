// #ifndef Geometry_CommonTopologies_CAConstants_h
// #define Geometry_CommonTopologies_CAConstants_h
//
// #include <cstdint>
//
...
//       static_assert(nPairs <= maxNumberOfLayerPairs);
//
