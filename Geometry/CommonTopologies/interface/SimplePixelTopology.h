...
namespace phase2PixelTopology
{
  ...
  DEVICECONST uint32_t layerStart[numberOfLayers + 1] = {0,
     ...
     DEVICECONST int16_t phicuts[nPairs]{
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
       phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,phi0p09,
     ...
     DEVICECONST float minz[nPairs] = {
       ...
       -9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,
        //
        // -16.0,4.0,-22.0,-17.0,6.0,-22.0,-18.0,11.0,-22.0,
        // 23.0,30.0,39.0,50.0,65.0,82.0,109.0,-28.0,-35.0,
        // -44.0,-55.0,-70.0,-87.0,-113.0,-16.,7.0,-22.0,
        // 11.0,-22.0,-17.0,9.0,-22.0,13.0,-22.0,137.0,173.0,
        // 199.0,229.0,-142.0,-177.0,-203.0,-233.0,23.0,30.0,
        // 39.0,50.0,65.0,82.0,109.0,-28.0,-35.0,-44.0,-55.0,
        // -70.0,-87.0,-113.0
      };
     ...
     DEVICECONST float maxz[nPairs] = {
       ...
       // 17.0,22.0,-4.0,17.0,22.0,-6.0,18.0,22.0,-11.0,
       // 28.0,35.0,44.0,55.0,70.0,87.0,113.0,-23.0,-30.0,
       // -39.0,-50.0,-65.0,-82.0,-109.0,17.0,22.0,-7.0,
       // 22.0,-10.0,17.0,22.0,-9.0,22.0,-13.0,142.0,177.0,
       // 203.0,233.0,-137.0,-173.0,-199.0,-229.0,28.0,35.0,
       // 44.0,55.0,70.0,87.0,113.0,-23.0,-30.0,-39.0,-50.0,
       // -65.0,-82.0,-109.0
     };
     ...
     DEVICECONST float maxr[nPairs] = {
       ...
       // 5.0,5.0,5.0,7.0,8.0,8.0,7.0,7.0,7.0,6.0,6.0,
       // 6.0,6.0,5.0,6.0,5.0,6.0,6.0,6.0,6.0,5.0,6.0,
       // 5.0,5.0,5.0,5.0,5.0,5.0,5.0,8.0,8.0,8.0,
       // 8.0,6.0,5.0,5.0,5.0,6.0,5.0,5.0,5.0,9.0,9.0,
       // 9.0,8.0,8.0,8.0,11.0,9.0,9.0,9.0,8.0,8.0,8.0,
       // 11.0
     };
}
...
namespace pixelTopology{
 ...
 uint16_t toRocY(uint16_t py);
   ...
   struct Phase2 : public topology
   {
     ...
     static constexpr uint32_t maxNumberOfDoublets = 3 * 512 * 1024;
     ...
     static constexpr int nPairsFarForwards = nPairsMinimal + 8; //nPairsForQuadruplets + 6 + 14;  // include barrel "jumping" layer pairs
