...
namespace phase1PixelTopology {
  ...
  HOST_DEVICE_CONSTANT float maxr[nPairs] = {20., 9., 9., 20., 7., 7., 5., 5., 20., 6., 6., 5., 5., 20., 20., 9., 9., 9., 9.};
...
namespace phase2PixelTopology {
  ...
  HOST_DEVICE_CONSTANT float minz[nPairs] = {-16.0,  4.0,   -22.0, -17.0, 6.0,    -22.0,  -18.0,  11.0,   -22.0, 23.0,  30.0,
