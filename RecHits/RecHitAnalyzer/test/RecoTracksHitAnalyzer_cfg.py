...
process.source = cms.Source("PoolSource",
    # Input file(s)
    fileNames = cms.untracked.vstring("file:step3_RAW2DIGI_RECO_VALIDATION_DQM.root")
)
...
process.RecHitAnalyzerHelp = cms.EDAnalyzer("RecHitAnalyzerTracks",
    recHits = cms.InputTag("siStripClusters"),
    pixels = cms.InputTag("pixelTracks"),
    recHitCollectionMatched = cms.InputTag("myConverter", "matchedRecHit"),
