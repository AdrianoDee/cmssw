  ...
  for (uint32_t offset = 0; offset < maxNumberOfTuples; offset += maxNumberOfConcurrentFits_) {
    ...
    if (fitNas4_) {
      ...
      kernel_BLFit<4,TrackerTraits><<<numberOfBlocks / 4, blockSize, 0, stream>>>(tupleMultiplicity_,
                                                                    ...
                                                                    fast_fit_resultsGPU.get());
      // fit penta (all 5)
      kernel_BLFastFit<5,TrackerTraits><<<numberOfBlocks / 4, blockSize, 0, stream>>>(tuples_,
                                                                        tupleMultiplicity_,
                                                                        hv,
                                                                        tkidGPU.get(),
                                                                        hitsGPU.get(),
      ...
      kernel_BLFit<5,TrackerTraits><<<8, blockSize, 0, stream>>>(tupleMultiplicity_,
                                                   bField_,
                                                   outputSoa_,
                                                   tkidGPU.get(),
                                                   hitsGPU.get(),
      ...
      kernel_BLFastFit<6,TrackerTraits><<<4, blockSize, 0, stream>>>(tuples_,
                                                       tupleMultiplicity_,
                                                       hv,
                                                       tkidGPU.get(),
                                                       hitsGPU.get(),
      ...
      kernel_BLFit<6,TrackerTraits><<<4, blockSize, 0, stream>>>(tupleMultiplicity_,
                                                   bField_,
                                                   outputSoa_,
                                                   tkidGPU.get(),
                                                   hitsGPU.get(),
