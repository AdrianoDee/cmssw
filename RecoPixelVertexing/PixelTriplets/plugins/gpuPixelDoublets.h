...
namespace gpuPixelDoublets {
  ...
  CONSTANT_VAR float const maxr[nPairs] = {
    ...
    CONSTANT_VAR float const minzPhase2[nPairsPhase2] = {
      -20.,   -3.,  -20.,  -19.,    3.,  -20.,   22.,   32.,   39.,
       51.,   67.,   84.,  108.,  -27.,  -34.,  -42.,  -54.,  -68.,
    ...
    CONSTANT_VAR float const maxzPhase2[nPairsPhase2] = {
       20.,   20.,    3.,   19.,   20.,   -3.,   27.,   34.,   42.,
       54.,   69.,   87.,  111.,  -23.,  -31.,  -39.,  -51.,  -67.,
    ...
    CONSTANT_VAR float const maxrPhase2[nPairsPhase2] = {
        6. ,  13.5,  13.5,   7.5,  12. ,  12. ,   7.5,   7.5,   7.5,
        7.5,   6. ,   6. ,   6. ,   7.5,   7.5,   7.5,   7.5,   6. ,
        6. ,   6. ,  12. ,  12. ,  12. , 150. ,  12. ,  12. ,  12. ,
        12. ,  12. ,  10.5,  10.5,  10.5,  16.5,  12. ,  12. ,  12. ,
        10.5,  10.5,  10.5,  16.5,   7.5,   9. ,   9. ,   7.5,   6. ,
        6. ,   6. ,   7.5,   6. ,   6. ,   6.};
        // 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0,
        // 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0,
        // 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0, 1000.0,
    ...
    CONSTANT_VAR float const maxZ0Phase2[nPairsPhase2] = {
        // 9.,  8.,  8.,
        // 9.,  9.,  9.,  9.,  9.,  9.,  9.,  9.,  9.,  9.,
        // 9.,  9.,  9.,  9.,  9.,  9.,  9., 10.,  8.,  8., 12.,  9.,  9.,
        // 9.,  9.,  9.,  9., 12., 11.,  9.,  9.,  9.,  9.,  9., 11., 12.,
