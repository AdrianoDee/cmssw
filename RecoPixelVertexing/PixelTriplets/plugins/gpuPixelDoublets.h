...
// };
  ...
  constexpr int16_t phi0p09 = 960;  // round(730.12648...) = phi2short(0.07);
    ...
    CONSTANT_VAR const int16_t phicutsPhase2[nPairsPhase2]{
                                             ...
                                             phi0p05, phi0p05,phi0p05, phi0p05,phi0p05, phi0p05,phi0p05, phi0p05,
                                             phi0p05, phi0p05,phi0p05, phi0p05,phi0p05, phi0p05,phi0p05, phi0p05,
                                             phi0p05, phi0p05,phi0p05, phi0p05,phi0p05, phi0p05,phi0p05, phi0p05
                                           };
  ...
  CONSTANT_VAR float const maxr[nPairs] = {
    ...
    //   13, 23, -3, 28, 5, 35, 5, 44, 5, 56, 5, 70, 5, 89,
    //   5, 113, 5, 15, 23, -5, 18, 23, -8, 143, 5, 178, 5,
    //   204, 5, 234, 5, 23, -23, 23, -56, 23, -31, 23, -72,
    //    23, -40, 23, -92, 10, 12};
    //   //, 5, 71, 5, 90, 5, 114, 5, 144, 5, 179, 5, 205};
    //
    // CONSTANT_VAR float const minzPhase2[nPairsPhase2] = {
    //   -13, 3, -23, -5, -32, -5, -39, -5, -47, -5, -59, -5,
    //   -74, -5, -92, -5, -116, -15, 5, -23, -18, 8, -23, -5,
    //   -147, -5, -182, -5, -208, -5, -237, 15, -23, 37, -23,
    //   21, -23, 50, -23, 28, -23, 66, -23, -10, -12};
    // //
    // //   // -71, -5, -90, -5, -114, -5, -144,
    // //   // -5, -179, -5, -205, -5};
    // //
    // CONSTANT_VAR float const maxrPhase2[nPairsPhase2] = {
    //   13, 15, 16, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    //   23, 23, 23, 23, 14, 17, 19, 14, 19, 21, 32, 32, 29,
    //   29, 29, 29, 29, 29, 11, 11, 8, 8, 11, 11, 8, 8, 11,
    //   11, 8, 8, 17, 18};
