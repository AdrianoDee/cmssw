...
void HelixFitOnGPUT<TrackerTraits>::launchBrokenLineKernelsOnCPU(HitsView const* hv, uint32_t hitsInFit, uint32_t maxNumberOfTuples) {
  assert(tuples_);
  ...
  for (uint32_t offset = 0; offset < maxNumberOfTuples; offset += maxNumberOfConcurrentFits_) {
    ...
    if (fitNas4_)
    {
    ...
    else
      {
        ...
        riemannFit::rolling_fits<4,TrackerTraits::maxHitsOnTrackForFullFit-2,1>([this,&hv,&tkidGPU,&hitsGPU,&hits_geGPU,&fast_fit_resultsGPU,&offset](auto i)
        {
          ...
          kernel_BLFastFit<TrackerTraits::maxHitsOnTrackForFullFit-1,TrackerTraits>(tuples_,
                            tupleMultiplicity_,
                            hv,
                            tkidGPU.get(),
                            hitsGPU.get(),
                            hits_geGPU.get(),
                            fast_fit_resultsGPU.get(),
                            TrackerTraits::maxHitsOnTrackForFullFit-1,
                            TrackerTraits::maxHitsOnTrack-1,
                            offset);

          kernel_BLFit<TrackerTraits::maxHitsOnTrackForFullFit-1,TrackerTraits>(tupleMultiplicity_,
                              bField_,
                              outputSoa_,
                              tkidGPU.get(),
                              hitsGPU.get(),
    ...
    //                   fast_fit_resultsGPU.get());
    //   // fit penta (all 5)
    //   kernel_BLFastFit<5,TrackerTraits>(tuples_,
    //                       tupleMultiplicity_,
    //                       hv,
    //                       tkidGPU.get(),
    //                       hitsGPU.get(),
    ...
    //                       offset);
    //
    //   kernel_BLFit<5,TrackerTraits>(tupleMultiplicity_,
    //                   bField_,
    //                   outputSoa_,
    //                   tkidGPU.get(),
    //                   hitsGPU.get(),
    ...
    //   kernel_BLFastFit<6,TrackerTraits>(tuples_,
    //                       tupleMultiplicity_,
    //                       hv,
    //                       tkidGPU.get(),
    //                       hitsGPU.get(),
    ...
    //                       offset);
    //
    //   kernel_BLFit<6,TrackerTraits>(tupleMultiplicity_,
    //                   bField_,
    //                   outputSoa_,
    //                   tkidGPU.get(),
    //                   hitsGPU.get(),
