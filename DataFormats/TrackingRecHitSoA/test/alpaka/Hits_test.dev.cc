...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  namespace testTrackingRecHitSoA {
    ...
    struct TestFillKernel {
      ...
      ALPAKA_FN_ACC void operator()(Acc1D const& acc, TrackingRecHitSoAView soa) const {
    ...
    struct ShowKernel {
      ...
      ALPAKA_FN_ACC void operator()(Acc1D const& acc, TrackingRecHitSoAConstView soa) const {
