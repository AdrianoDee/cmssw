...
(pp_on_AA | pp_on_PbPb_run3).toReplaceWith(siPixelRecHitsPreSplittingCPU, _siPixelRecHitsPreSplittingSoAHIonPhase1.clone(convertToLegacy=True, CPE = cms.string('PixelCPEFastHIonPhase1')))
...
(pp_on_AA | pp_on_PbPb_run3).toReplaceWith(siPixelRecHitsPreSplittingCUDA,_siPixelRecHitCUDAHIonPhase1.clone(
    beamSpot = "offlineBeamSpotToCUDA"
))
...
(pp_on_AA | pp_on_PbPb_run3).toModify(siPixelRecHitsPreSplittingSoA,
cpu = cms.EDAlias(
        siPixelRecHitsPreSplittingCPU = cms.VPSet(
             cms.PSet(type = cms.string("pixelTopologyHIonPhase1TrackingRecHit2DCPUT")),
             cms.PSet(type = cms.string("uintAsHostProduct"))
         )))
...
(gpu & pixelNtupletFit & (pp_on_AA | pp_on_PbPb_run3)).toModify(siPixelRecHitsPreSplittingSoA, cuda = _siPixelRecHitSoAFromCUDAHIonPhase1.clone())
...
(gpu & pixelNtupletFit & (pp_on_AA | pp_on_PbPb_run3)).toModify(siPixelRecHitsPreSplitting, cuda = _siPixelRecHitFromCUDAHIonPhase1.clone())
