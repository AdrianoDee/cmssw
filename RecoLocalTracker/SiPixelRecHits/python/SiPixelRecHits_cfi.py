...
phase2_tracker.toReplaceWith(siPixelRecHitsPreSplittingSoA, _siPixelRecHitsPreSplittingSoAPhase2.clone(convertToLegacy=True, CPE = cms.string('PixelCPEFastPhase2')))
