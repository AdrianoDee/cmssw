// #ifndef RecoLocalTracker_SiPixelClusterizer_SiPixelRawToClusterKernelRawToDigi_h
// #define RecoLocalTracker_SiPixelClusterizer_SiPixelRawToClusterKernelRawToDigi_h
...
//     inline ALPAKA_FN_ACC ::pixelDetails::Pixel frameConversion(
