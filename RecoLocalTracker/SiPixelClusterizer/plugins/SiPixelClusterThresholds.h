...
struct SiPixelClusterThresholds {
  ...
  //For Phase1
  SiPixelClusterThresholds(const int32_t layer1,
    const int32_t otherLayers, const float vCaltoElectronGain,
    const float vCaltoElectronGain_L1, const float vCaltoElectronOffset,
  ...
  //For Phase2
  SiPixelClusterThresholds(const int32_t layer1,
    const int32_t otherLayers, const float electronPerADCGain,
