...
layerPairs = [
    ...
    #  i,  o, start,  skip, phiCut,  minIn,  maxIn,  minOut,  maxOut, maxDR,  minDZ,  maxDZ, ptCuts, z0Cuts
    [  0,  1,  True, False,    350,  -17.0,   17.0,  -10000,   10000,   5.0,  -16.0,   16.0,  0.85,    12.5],
    [  0,  2,  True, False,    600,  -14.0,   14.0,  -10000,   10000,  10.0,  -16.0,   16.0,  0.85,    12.5],
    [  0,  4,  True, False,    450,    4.0,  10000,       0,    10.0,   8.0,    0.0,   25.0,  0.85,    12.5],
    [  0,  5,  True, False,    522,    7.0,  10000,       0,   10000,   5.0,    0.0,   25.0,  0.85,    12.5],
  # [  0,  6, False, False,    522,   11.0,  10000,       0,   10000,   5.0, -10000,  10000,  0.85,    12.5],
    [  0, 16,  True, False,    450, -10000,   -4.0,       0,    10.0,   8.0,  -25.0,    0.0,  0.85,    12.5],
    [  0, 17,  True, False,    522, -10000,   -7.0,       0,   10000,   5.0,  -25.0,    0.0,  0.85,    12.5],
  # [  0, 18, False, False,    522, -10000,  -10.0,       0,   10000,   5.0, -10000,  10000,  0.85,    12.5],
    [  1,  2,  True, False,    400,  -17.0,   17.0,  -10000,   10000,   7.0,  -13.0,   13.0,  0.85,    12.5],
    [  1,  3, False, False,    650,  -15.0,   15.0,  -10000,   10000,  10.0,  -15.0,   15.0,  0.85,    12.5],
    [  1,  4,  True, False,    500,    6.0,  10000,     6.5,   10000,   8.0,    0.0,   19.0,  0.85,    12.5],
    [  1,  5, False, False,    730,    9.0,  10000,     6.5,   10000,  10.0,    0.0,   21.0,  0.85,    12.5],
  # [  1,  6, False, False,    730,   13.0,  10000,     6.5,   10000,   8.0, -10000,  10000,  0.85,    12.5],
    [  1, 16,  True, False,    500, -10000,   -6.0,     6.5,   10000,   8.0,  -19.0,    0.0,  0.85,    12.5],
    [  1, 17, False, False,    730, -10000,   -9.0,     6.5,   10000,  10.0,  -21.0,    0.0,  0.85,    12.5],
  # [  1, 18, False, False,    730, -10000,  -13.0,     6.5,   10000,   8.0, -10000,  10000,  0.85,    12.5],
  # [  1, 28, False, False,   1300,    7.0,  10000,    30.0,    40.0, 10000,   19.0,   32.0,   1.0,    12.5],
  # [  1, 28, False, False,   1300, -10000,   -7.0,   -40.0,   -30.0, 10000,  -32.0,  -19.0,   1.0,    12.5],
    [  2,  3,  True, False,    350,  -18.0,   18.0,  -10000,   10000,   7.0,   -9.0,    9.0,  0.85,    12.5],
    [  2,  4, False, False,    400,   11.0,  10000,    11.7,   10000,   7.0,    0.0,   13.0,  0.85,    12.5],
    [  2, 16, False, False,    400, -10000,  -11.0,    11.7,   10000,   7.0,  -13.0,    0.0,  0.85,    12.5],
    [  2, 28, False, False,   1200,    -10,     10,   -30.0,    30.0, 10000,  -15.0,   15.0,   2.0,    12.5],
    [  2, 28, False, False,   1200,    -20,    -10,   -50.0,   -25.0, 10000,  -35.0,  -10.0,  0.85,    12.5],
    [  2, 28, False, False,   1200,     10,     20,    25.0,    50.0, 10000,   10.0,   35.0,  0.85,    12.5],
  # [  2, 28, False, False,   1200,    -20,     20,   -50.0,    50.0, 10000,  -35.0,   35.0,  0.85,    12.5],
    [  3, 28, False, False,   1000,    -20,     20,   -45.0,    45.0, 10000,  -22.0,   22.0,  0.85,    12.5],
  # [  3, 29, False, False,   1500,    -40,     40,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [  4,  5,  True, False,    300,      0,   14.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [  4,  6, False, False,    522,      0,   14.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,    12.5],
    [  4, 28, False, False,   1000,   11.6,  10000,    30.0,    57.5,  16.0,    5.0,   32.5,  0.85,    12.5],
  # [  4, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [  5,  6,  True, False,    300,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [  5,  7, False, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,    12.5],
    [  5, 28, False, False,   1000,   11.6,  10000,    40.0,    80.0,  16.0,  -10.0,   50.0,  0.85,    12.5],
  # [  5, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [  6,  7,  True, False,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [  6,  8, False, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,    12.5],
    [  6, 28, False, False,   1000,   11.6,  10000,    55.0,    95.0,  16.0,    5.0,   50.0,  0.85,    12.5],
  # [  6, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [  7,  8,  True, False,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [  7,  9, False, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,    12.5],
    [  7, 28, False, False,   1000,   11.8,  10000,    70.0,   110.0,  16.0,   15.0,   70.0,  0.85,    12.5],
  # [  7, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [  8,  9,  True, False,    250,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [  8, 10, False, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,    12.5],
    [  8, 28, False, False,    850,      0,  10000,    80.0,   10000,  14.0,   25.0,   70.0,  0.85,    12.5],
  # [  8, 29, False, False,   1000,      0,  10000,       0,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [  9, 10,  True, False,    300,      0,   13.0,     4.0,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [  9, 11, False, False,    522,      0,   13.0,     4.0,   10000,   8.0, -10000,  10000,  0.85,    12.5],
  # [  9, 28, False, False,   1000,      0,  10000,       0,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 10, 11,  True, False,    240,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 10, 12, False, False,    650,   12.5,   16.5,    20.0,   10000,  10.0, -10000,  10000,  0.85,    12.5],
    [ 11, 12, False, False,    300,      0,   16.5,     6.0,    21.0,   5.0, -10000,  10000,  0.85,    12.5],
    [ 11, 13, False, False,    200,      0,    6.0,       0,     7.5,   3.0, -10000,  10000,  0.85,    12.5],
    [ 11, 14, False, False,    220,      0,    4.6,       0,     7.5,   3.0, -10000,  10000,  0.85,    12.5],
    [ 11, 15, False, False,    250,      0,    6.0,       0,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 12, 13, False, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 13, 14, False, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 14, 15, False, False,    250,      0,   22.5,     7.0,   10000,   3.5, -10000,  10000,  0.85,    12.5],
    [ 16, 17,  True, False,    300,      0,   14.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [ 16, 18, False, False,    522,      0,   14.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,    12.5],
    [ 16, 28, False, False,   1000,   11.6,  10000,   -57.5,   -30.0,  16.0,  -32.5,   -5.0,  0.85,    12.5],
  # [ 16, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 17, 18,  True, False,    300,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [ 17, 19, False, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,    12.5],
    [ 17, 28, False, False,   1000,   11.6,  10000,   -70.0,   -40.0,  16.0,  -50.0,  -10.0,  0.85,    12.5],
  # [ 17, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 18, 19,  True, False,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [ 18, 20, False, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,    12.5],
    [ 18, 28, False, False,   1000,   11.6,  10000,   -95.0,   -55.0,  16.0,  -50.0,   -5.0,  0.85,    12.5],
  # [ 18, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 19, 20,  True, False,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [ 19, 21, False, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,    12.5],
    [ 19, 28, False, False,   1000,   11.8,  10000,  -110.0,   -70.0,  16.0,  -70.0,  -15.0,  0.85,    12.5],
  # [ 19, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 20, 21,  True, False,    250,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 20, 22, False, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,    12.5],
    [ 20, 28, False, False,   1000,      0,  10000,  -10000,   -80.0,  14.0,  -70.0,  -25.0,  0.85,    12.5],
  # [ 20, 29, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 21, 22,  True, False,    300,      0,   13.0,     4.0,   10000,   4.5, -10000,  10000,  0.85,    12.5],
    [ 21, 23, False, False,    522,      0,   13.0,     4.0,   10000,   8.0, -10000,  10000,  0.85,    12.5],
  # [ 21, 28, False, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 22, 23,  True, False,    240,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 22, 24, False, False,    650,   12.5,   16.5,    20.0,   10000,  10.0, -10000,  10000,  0.85,    12.5],
    [ 23, 24, False, False,    300,      0,   16.5,     6.0,    21.0,   5.0, -10000,  10000,  0.85,    12.5],
    [ 23, 25, False, False,    200,      0,    6.0,       0,     7.5,   3.0, -10000,  10000,  0.85,    12.5],
    [ 23, 26, False, False,    220,      0,    4.6,       0,     7.5,   3.0, -10000,  10000,  0.85,    12.5],
    [ 23, 27, False, False,    250,      0,    6.0,       0,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 24, 25, False, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 25, 26, False, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,    12.5],
    [ 26, 27, False, False,    250,      0,   22.5,     7.0,   10000,   3.5, -10000,  10000,  0.85,    12.5],
    [ 28, 29, False, False,   1100,  -1200,   1200,  -10000,   10000, 10000,  -50.0,   50.0,  0.85,    12.5],
  # [ 28, 30, False, False,   2000,    -40,     40,  -10000,   10000, 10000, -10000,  10000,  0.85,    12.5],
    [ 29, 30, False, False,   1250,  -1200,   1200,  -10000,   10000, 10000,  -40.0,   40.0,  0.85,    12.5],
]
