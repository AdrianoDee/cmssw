...
layers = [
    ...
    # Pixel barrel layers
    [     0,     True,  0.15,   0.002,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     1,     True,  0.25,   0.002,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     2,     True,  0.20,   0.002,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     3,     True,  0.20,   0.002,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    # Pixel endcap layers (forward)
    [     4,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     5,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     6,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     7,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     8,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [     9,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    10,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    11,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    12,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    13,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    14,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    15,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    # Pixel endcap layers (backward)
    [    16,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    17,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    18,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    19,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    20,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    21,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    22,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    23,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    24,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    25,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    26,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    [    27,    False,  0.25,   0.003,      -1.0,       -1.0,       -1.0,       -1.0,       0.005],
    ...
    [    28,     True,  0.30,   0.003,      5.0,       0.05,        -1.0,       -1.0,       0.005],
    [    29,     True,  0.30,   0.003,      5.0,       0.2,         -1.0,       -1.0,       0.005],
    [    30,     True,  0.30,   0.003,      5.0,       0.015,       -1.0,       -1.0,       0.005],
    [    31,     True,  0.30,   0.01,       5.0,       0.015,        0.1,        0.1,       0.005],
    [    32,     True,  0.30,   0.01,       5.0,       0.015,        0.1,        0.1,       0.005],
    [    33,     True,  0.30,   0.01,       5.0,       0.015,        0.1,        0.1,       0.005],
    ...
    [    34,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    35,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    36,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    37,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    38,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    # OT endcap forward disks 1-5 (stubs)
    # caTheta (col 3): PS-only cut (0.03). caTheta1SS (col 6): 1 SS stub cut.
    # caTheta2SS (col 7): 2+ SS stubs, nearly disabled (99.0 = rely on other cuts).
    [    39,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    40,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    41,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    42,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
    [    43,    False,  0.30,   0.030,       5.0,        0.1,       0.08,       99.0,       0.005],
]
...
layerPairs = [
    ...
    [  2, 28, False,   1200,    -10,     10,   -30.0,    30.0, 10000,  -15.0,   15.0,   2.0,   4.0],  # central
    [  2, 28, False,   1200,    -20,    -10,   -50.0,   -25.0, 10000,  -35.0,  -10.0,  0.85,   4.0],  # backward
    [  2, 28, False,   1200,     10,     20,    25.0,    50.0, 10000,   10.0,   35.0,  0.85,   4.0],  # forward
    ...
    [  4, 28, False,   1000,   11.6,  10000,    30.0,    57.5,  16.0,    5.0,   32.5,  0.85,   5.0],
    [  5, 28, False,   1000,   11.6,  10000,    40.0,    70.0,  16.0,    5.0,   50.0,  0.85,   5.0],
    [  6, 28, False,   1000,   11.6,  10000,    55.0,    95.0,  16.0,    5.0,   50.0,  0.85,   8.0],
    [  7, 28, False,   1000,   11.8,  10000,    70.0,   110.0,  16.0,   15.0,   70.0,  0.85,   8.0],
    [  8, 28, False,   1000,      0,  10000,    80.0,   10000,  14.0,   25.0,   70.0,  0.85,   8.0],
    # Pixel backward endcap disks to OT barrel L1 (CA 28) - from HLT CA extension
    [ 16, 28, False,   1000,   11.6,  10000,   -57.5,   -30.0,  16.0,  -32.5,   -5.0,  0.85,   5.0],
    [ 17, 28, False,   1000,   11.6,  10000,   -70.0,   -40.0,  16.0,  -50.0,   -5.0,  0.85,   5.0],
    [ 18, 28, False,   1000,   11.6,  10000,   -95.0,   -55.0,  16.0,  -50.0,   -5.0,  0.85,   8.0],
    [ 19, 28, False,   1000,   11.8,  10000,  -110.0,   -70.0,  16.0,  -70.0,  -15.0,  0.85,   8.0],
    [ 20, 28, False,   1000,      0,  10000,  -10000,   -80.0,  14.0,  -70.0,  -25.0,  0.85,   8.0],
