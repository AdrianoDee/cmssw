...
layerPairs = [
    ...
    [ 34, 36, False, False,   2500,     20,    115,      20,     115,  60.0,  15.0,   50.0,   0.85,   18.0,       6.5,       5.0,    0.1,   0.02,  0.65, 0.0002],
    [ 36, 38, False, False,   2500,     20,    115,      20,     115,  60.0,  15.0,   50.0,   0.85,   18.0,       5.6,       5.0,    0.1,   0.02,  0.65, 0.0002],
    [ 38, 40, False, False,   2500,     20,    115,      20,     115,  60.0,  15.0,   50.0,   0.85,   18.0,       5.4,       5.0,    0.1,   0.02,  0.65, 0.0002],
    [ 40, 42, False, False,   2500,     20,    115,      20,     115,  60.0,  15.0,   50.0,   0.85,   18.0,       6.0,       5.0,    0.1,   0.02,  0.65, 0.0002],
    # Forward disk to disk consecutive connections (layers 39-43)
    # For forward disks: dz > 0 (moving to more positive z)
    [ 44, 46, False, False,   2500,     20,    115,      20,     115,  60.0,  -50.0,  -15.0,   0.85,   18.0,       6.5,       5.0,    0.1,   0.02,  0.65, 0.0002],
    [ 46, 48, False, False,   2500,     20,    115,      20,     115,  60.0,  -50.0,  -15.0,   0.85,   18.0,       5.6,       5.0,    0.1,   0.02,  0.65, 0.0002],
    [ 48, 50, False, False,   2500,     20,    115,      20,     115,  60.0,  -50.0,  -15.0,   0.85,   18.0,       5.4,       5.0,    0.1,   0.02,  0.65, 0.0002],
    [ 50, 52, False, False,   2500,     20,    115,      20,     115,  60.0,  -50.0,  -15.0,   0.85,   18.0,       6.0,       5.0,    0.1,   0.02,  0.65, 0.0002],
]
