...
layerPairs = [
    ...
    [ 30, 31, False, False,   1250, -10000,  10000,  -10000,   10000, 10000,  -30.0,   30.0,   0.85,   30.0,       5.0,       5.0,    0.1,   3.000,  0.50, 0.000],
    ...
    [ 34, 36, False, False,   2500,     20,    115,      20,     115,  60.0,  -35.0,  -10.0,   0.85,   18.0,       6.5,       5.0,    0.1,   0.005,  0.50, 0.000],
    [ 36, 38, False, False,   2500,     20,    115,      20,     115,  60.0,  -55.0,  -20.0,   0.85,   18.0,       5.6,       5.0,    0.1,   0.005,  0.50, 0.000],
    [ 38, 40, False, False,   2500,     20,    115,      20,     115,  60.0,  -55.0,  -20.0,   0.85,   18.0,       5.4,       5.0,    0.1,   0.005,  0.50, 0.000],
    [ 40, 42, False, False,   2500,     20,    115,      20,     115,  60.0,  -70.0,  -25.0,   0.85,   18.0,       6.0,       5.0,    0.1,   0.005,  0.50, 0.000],
    # Forward disk to disk consecutive connections (layers 39-43)
    # For forward disks: dz > 0 (moving to more positive z)
    [ 44, 46, False, False,   2500,     20,    115,      20,     115,  60.0,   10.0,   35.0,   0.85,   18.0,       6.5,       5.0,    0.1,   0.005,  0.50, 0.000],
    [ 46, 48, False, False,   2500,     20,    115,      20,     115,  60.0,   20.0,   55.0,   0.85,   18.0,       5.6,       5.0,    0.1,   0.005,  0.50, 0.000],
    [ 48, 50, False, False,   2500,     20,    115,      20,     115,  60.0,   20.0,   55.0,   0.85,   18.0,       5.4,       5.0,    0.1,   0.005,  0.50, 0.000],
    [ 50, 52, False, False,   2500,     20,    115,      20,     115,  60.0,   25.0,   70.0,   0.85,   18.0,       6.0,       5.0,    0.1,   0.005,  0.50, 0.000],
]
