...
hltPhase2PixelTrackTorchHighPuritySelectorLowPt = cms.EDProducer('PixelTrackTorchHighPuritySelector@alpaka',
    pixelTrackSrc = cms.InputTag('hltPhase2PixelTracksSoALowPt'),
