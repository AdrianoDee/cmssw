...
# with command line options: step3 -s RAW2DIGI,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --conditions auto:phase2_realistic_T35 -n -1 --era Phase2C22I13M9 --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --nThreads=32 --geometry ExtendedRun4D121 --filein file:SingleMuPt10_step2_DIGI_L1_DIGI2RAW_HLT_PhaseII.root --fileout file:SingleMuPt10_step3_RECO_DQM_PhaseII.root --python_filename SingleMuPt10_step2_RECO_DQM_PhaseII.py
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C22I13M9_cff import Phase2C22I13M9

process = cms.Process('RECO',Phase2C22I13M9)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SingleMuPt10_step2_DIGI_L1_DIGI2RAW_HLT_PhaseII.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleMuPt10_step3_RECO_DQM_PhaseII.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleMuPt10_step3_RECO_DQM_PhaseII_inMINIAODSIM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleMuPt10_step3_RECO_DQM_PhaseII_inDQM.root'),
...
process.prevalidation_step8 = cms.Path(process.globalPrevalidationBarrel)
process.prevalidation_step9 = cms.Path(process.hltprevalidation)
process.prevalidation_step10 = cms.Path(process.prevalidationMiniAOD)
...
process.validation_step10 = cms.EndPath(process.globalValidationBarrel)
process.validation_step11 = cms.EndPath(process.globalValidationMTD)
...
process.validation_step14 = cms.EndPath(process.hltvalidation)
