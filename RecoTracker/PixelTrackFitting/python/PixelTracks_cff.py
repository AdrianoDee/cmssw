...
(pixelNtupletFit & (pp_on_AA | pp_on_PbPb_run3)).toReplaceWith(pixelTracks, _pixelTrackProducerFromSoAHIonPhase1.clone(
    pixelRecHitLegacySrc = "siPixelRecHitsPreSplitting",
))
...
(gpu & (pp_on_AA | pp_on_PbPb_run3)).toModify(pixelTracksSoA,cuda = _pixelTracksSoAHIonPhase1.clone(
))
...
(pp_on_AA | pp_on_PbPb_run3).toModify(pixelTracksSoA,cpu = _pixelTracksCUDAHIonPhase1.clone(
    pixelRecHitSrc = "siPixelRecHitsPreSplittingSoA",
    onGPU = False
))
...
(pp_on_AA | pp_on_PbPb_run3).toReplaceWith(pixelTracksCUDA,_pixelTracksCUDAHIonPhase1.clone(
    pixelRecHitSrc = "siPixelRecHitsPreSplittingCUDA",
    onGPU = True,
))
