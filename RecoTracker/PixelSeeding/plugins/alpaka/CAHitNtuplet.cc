...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  CAHitNtupletAlpaka<TrackerTraits>::CAHitNtupletAlpaka(const edm::ParameterSet& iConfig,
      ...
      : EDProducer(iConfig),
        ...
        maxNumberOfDoublets_(iConfig.getParameter<std::string>("maxNumberOfDoublets").data()),
        maxNumberOfTuples_(iConfig.getParameter<std::string>("maxNumberOfTuples").data()),
        deviceAlgo_(iConfig) {
