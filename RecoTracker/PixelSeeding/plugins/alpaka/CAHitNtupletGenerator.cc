...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  reco::TracksSoACollection CAHitNtupletGenerator<TrackerTraits>::makeTuplesAsync(HitsOnDevice const& hits_d,
    ...
    kernels.buildDoublets(trackingHits, graph, layers, doubletCuts, hits_d.offsetBPIX2(), mask.view(), queue);
  ...
  void CAHitMaskingAndMerger::updateHitOffsets(int const& tksBeg,
                                               int const& tksEnd,
                                               int const& nHits,
