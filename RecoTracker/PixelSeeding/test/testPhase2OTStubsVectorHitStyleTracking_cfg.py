...
from HLTrigger.Configuration.HLT_75e33.eventsetup.hltESPPixelCPEFastParams_cfi import (
    hltESPPixelCPEFastParamsPhase2,
)
...
from HLTrigger.Configuration.HLT_75e33.sequences.HLTBeginSequence_cfi import (
    HLTBeginSequence,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltOnlineBeamSpot_cfi import (
    hltOnlineBeamSpot,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltPhase2OnlineBeamSpotDevice_cfi import (
    hltPhase2OnlineBeamSpotDevice,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltPhase2SiPixelClustersSoA_cfi import (
    hltPhase2SiPixelClustersSoA,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltPhase2SiPixelRecHitsSoA_cfi import (
    hltPhase2SiPixelRecHitsSoA,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltSiPhase2Clusters_cfi import (
    hltSiPhase2Clusters,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltSiPhase2RecHits_cfi import (
    hltSiPhase2RecHits,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltPixelSeedingOTRecHitsSoA_cfi import (
    hltPixelSeedingOTRecHitsSoA,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltOTStubProducerVectorHitStyle_cfi import (
    hltOTStubProducerVectorHitStyle as hltOTStubProducer,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltPhase2PixelRecHitsStubsMerger_cfi import (
    hltPhase2PixelRecHitsStubsMerger,
)
from HLTrigger.Configuration.HLT_75e33.modules.hltPhase2PixelTracksSoAWithStubs_cfi import (
    hltPhase2PixelTracksSoAWithStubs,
)

# Load legacy pixel clusters (required for legacy RecHits)
from HLTrigger.Configuration.HLT_75e33.modules.hltSiPixelClusters_cfi import (
    hltSiPixelClusters,
)
...
hltSiPixelRecHits = cms.EDProducer(
...
hltPhase2PixelTracksWithStubs = cms.EDProducer(
...
process.output = cms.OutputModule(
    "PoolOutputModule",
    fileName=cms.untracked.string("output_stubVectorHitStyle_tracking.root"),
...
# Schedule
process.schedule = cms.Schedule(process.stub_tracking_path, process.output_step)
